...
def MakeInputTarget(timesteps_in_one_Batch,Train,shift):
    ...
    scipy.sparse.save_npz("D:/EC2/Inputs/TargetInputOutput/Training_40_s5_3.npz", Xtrain, compressed=True)
    scipy.sparse.save_npz("D:/EC2/Inputs/TargetInputOutput/TrainingTarget_40_s5_3.npz", Ytrain, compressed=True) 
...
def MakeTestInputTarget(timesteps_in_one_Batch,Test,shift):
    ...
    scipy.sparse.save_npz("D:/EC2/Inputs/TargetInputOutput/Test_40_s5_3.npz", Xtest, compressed=True)
    scipy.sparse.save_npz("D:/EC2/Inputs/TargetInputOutput/TestTarget_40_s5_3.npz", Ytest, compressed=True) 
