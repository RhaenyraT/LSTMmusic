...
history=model.fit(X_train, Y_train, validation_data=(X_Validate, Y_Validate),  batch_size=179, epochs=NEpochs, verbose=1,callbacks=[roc_callback(validation_data=(X_Validate, Y_Validate))])
...
np.savetxt("D:/EC2/SavedModel/10seq/Loss.csv", Loss, delimiter=",") 
...
np.savetxt("D:/EC2/SavedModel/10seq/ValLoss.csv", ValLoss, delimiter=",") 

# serialize model to JSON
model_json = model.to_json()
with open("D:/EC2/SavedModel/10seq/model.json", "w") as json_file:
