...
Train      = scipy.sparse.load_npz("D:/EC2/Inputs/mixie/Train.npz")
Test       = scipy.sparse.load_npz("D:/EC2/Inputs/mixie/Test.npz")
Val        = scipy.sparse.load_npz("D:/EC2/Inputs/mixie/Val.npz")
...
Input_unshaped    = scipy.sparse.load_npz("D:/EC2/Inputs/mixie/TrainX_20_s5.npz")
...
print(X_train.shape)
Target_unshaped   = scipy.sparse.load_npz("D:/EC2/Inputs/mixie/TrainY_20_s5.npz")
Y_train           = Target_unshaped.toarray()
print(Y_train.shape)

ValX_unshaped   = scipy.sparse.load_npz("D:/EC2/Inputs/mixie/ValX_20_s5.npz")
...
ValY_unshaped   = scipy.sparse.load_npz("D:/EC2/Inputs/mixie/ValY_20_s5.npz")
...
TestInput_unshaped = scipy.sparse.load_npz("D:/EC2/Inputs/mixie/TestX_20_s5.npz")
...
history=model.fit(X_train, Y_train, validation_data=(X_Validate, Y_Validate),  batch_size=109, epochs=NEpochs, verbose=1,callbacks=[roc_callback(validation_data=(X_Validate, Y_Validate))])
...
np.savetxt("D:/EC2/SavedModel/mixie/Loss.csv", Loss, delimiter=",") 
#np.savetxt("D:/EC2/SavedModel/10seq/Val_AUC.csv", Val_AUC, delimiter=",") 
np.savetxt("D:/EC2/SavedModel/mixie/val_AUCcol.csv",Val_AUCcol, delimiter=",") 
#np.savetxt("D:/EC2/SavedModel/100100/ValCorr.csv", ValCorr, delimiter=",") 
np.savetxt("D:/EC2/SavedModel/mixie/ValLoss.csv", ValLoss, delimiter=",") 

# serialize model to JSON
model_json = model.to_json()
with open("D:/EC2/SavedModel/mixie/model.json", "w") as json_file:
    json_file.write(model_json)
print("Saved model to disk")
# serialize weights to HDF5
model.save_weights("D:/EC2/SavedModel/mixie/model.h5")
...
np.savetxt("D:/EC2/SavedModel/mixie/PredictedRawProbabilities.csv", PredictedRawProbabilities, delimiter=",") 
